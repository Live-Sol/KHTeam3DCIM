-- ==========================================================
-- [DCIM 프로젝트] 데이터베이스 전체 초기화 및 생성 스크립트
-- 작성일: 2025-12-27 (통합본)
-- ==========================================================
...
PROFILE_IMAGE VARCHAR2(200),          -- 프로필 이미지 경로
IS_DELETED    NUMBER(1)     DEFAULT 0 NOT NULL, -- 탈퇴 여부 (0:활성, 1:탈퇴)

    CONSTRAINT PK_MEMBER PRIMARY KEY (MEMBER_ID),
    CONSTRAINT CK_DC_MEMBER_IS_DELETED CHECK (IS_DELETED IN (0, 1))
);
...
REQ_ID        NUMBER        NOT NULL, -- 신청서 번호
    ...
    -- [추가 컬럼: 히스토리 관리]
    IS_HIDDEN     NUMBER(1)     DEFAULT 0 NOT NULL, -- 입고 이력 숨김 여부 (0:표시, 1:숨김)
    DELETE_REASON VARCHAR2(255),          -- 삭제(숨김) 사유
...
DEVICE_ID     NUMBER        NOT NULL, -- 장비 ID
    ...
    POWER_WATT    NUMBER(5)     DEFAULT 0, -- 전력 소비량
    EMS_STATUS    VARCHAR2(10)  DEFAULT 'OFF', -- EMS 감시 모드 여부
    ...
    -- [추가 컬럼: 논리 삭제]
    DELETED_AT    TIMESTAMP,              -- 삭제 일시 (논리 삭제용)
    DELETE_REASON VARCHAR2(255),          -- 삭제 사유
